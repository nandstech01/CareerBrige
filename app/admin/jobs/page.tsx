    ...
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-500/10 border border-emerald-500/30">
          ...
          <span className="text-sm text-emerald-600 dark:text-emerald-400 font-medium">{jobs.length}件</span>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="mt-2 w-full md:w-44 px-4 py-3 rounded-xl bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-600/50 text-slate-900 dark:text-white focus:outline-none focus:border-sky-500 dark:focus:border-purple-500/50 appearance-none cursor-pointer"
            >
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-slate-600 dark:text-slate-300">{job.company_name}</span>
                        </div>
                      </td>
                      <td className="py-4 px-6">
                      ...
                      <td className="py-4 px-6 text-right relative">
                        <button
                          ...
                          className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700/50 text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors"
                        >
                        ...
                        {openDropdown === job.id && (
                          <>
                            ...
                            />
                            <div className="absolute right-6 top-full mt-1 z-20 w-44 py-2 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700/50 shadow-xl shadow-black/10 dark:shadow-black/20 animate-scale-in">
                              <button
                                onClick={() => handleStatusChange(job.id, 'open')}
                                className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-500/10 transition-colors"
                              >
                              ...
                              <button
                                ...
                                className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:text-yellow-600 dark:hover:text-yellow-400 hover:bg-yellow-500/10 transition-colors"
                              >
                              ...
                              <button
                                ...
                                className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-orange-500/10 transition-colors"
                              >
