...
export default function AdminUsersPage() {
  ...
  const roleConfig = {
    engineer: {
      ...
      border: 'border-sky-500/30 dark:border-cyan-500/30'
    },
    company: {
      label: '企業',
      icon: Building2,
    ...
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-500/10 border border-purple-500/30">
          ...
          <span className="text-sm text-purple-600 dark:text-purple-400 font-medium">{users.length}人</span>
        </div>
      </div>
                      ...
                      <td className="py-4 px-6 text-right relative">
                        ...
                        {openDropdown === user.id && (
                          <>
                            ...
                            />
                            <div className="absolute right-6 top-full mt-1 z-20 w-48 py-2 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700/50 shadow-xl shadow-black/10 dark:shadow-black/20 animate-scale-in">
                              <button
                                onClick={() => handleRoleChange(user.id, 'admin')}
                                className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-purple-500/10 transition-colors"
                              >
                              ...
                              <button
                                ...
                                className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:text-sky-600 dark:hover:text-cyan-400 hover:bg-sky-500/10 dark:hover:bg-cyan-500/10 transition-colors"
                              >
